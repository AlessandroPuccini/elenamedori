...
function Home() {
  return (
      ...
      <div className="home-gallery">
        <img className="gallery-img" src="https://ik.imagekit.io/ae2125/elenamedori/rosa.jpg" alt="bag" />
        ...
        <img className="gallery-img" src="https://ik.imagekit.io/ae2125/elenamedori/interiorD4.png" alt="Interior" />
...
/*********home vecchia*************/
  ...
  //       <section>
  //         <h2 className='iban'>IBAN
  //           <br></br>
  //           <span className='iban'>IT 12 A 1234 5678 9012 3456 7890</span>
  //         </h2>
  //       </section>
  //     </div>
  //   </>